from .forms import LoginForm, AddRelationForm, LoginModalForm, VerifyIDAccountForm, ModifyPassword, UpdateForm, \
    SelectForm, DeleteForm
from flask import Flask, render_template, request, url_for, redirect, flash, session
from TeacherTree import app, db, login_manager
...
def homepage():
    ...
    if Student.query.get(account) is not None:
        ...
        for i in teachers_m:
            ...
            t.linkedin_link=temp_teacher.linkedin_link
            teachers.append(t)
    ...
    if Teacher.query.get(account) is not None:
        ...
        for i in range(len(students_m)):
            ...
            t.linkedin_link=temp_student.linkedin_link
            students.append(t)
...
def update():
    ...
    if m.validate_on_submit():
        ...
        cur.sex = m.sex.data
        cur.linkedin_link=m.scholar.data
        db.session.commit()
